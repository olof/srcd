...
git clone -q ssh://${USER}@$HOST:${PORT}/empty.git >/dev/null 2>&1
...
git clone -q ssh://${USER}@$HOST:${PORT}/no-content.git >/dev/null 2>&1
...
git clone -q ssh://${USER}@$HOST:${PORT}/content.git >/dev/null 2>&1
